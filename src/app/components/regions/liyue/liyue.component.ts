...
@Component({
  ...
  styleUrls: ['./liyue.component.css']
})
export class LiyueComponent {
  personnages:Personnages[] = []
  constructor(private personnagesService:PersonnagesService, private route:Router){}

  ngOnInit(): void {
    this.personnagesService.getByNationalite("nationalite/liyue").subscribe((data) => this.personnages = data)
  }
